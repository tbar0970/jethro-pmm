...
export const DEMO_NOUNS: NounCheck[] = [
  ...
  // The refreshed demodata (upstream, via import_demodata.sh) has no Calvin/Idelette
  // accounts; its user accounts are the test personas below.
  { noun: "staff_member", view: "view=admin__user_accounts", title: "User Accounts", samples: ["Dennis Demo", "Nakia Lockman", "Krista Kemmer"] },
  ...
  // The demodata's attendance rows span 2025-09 .. 2027-08; 2024 has none.
  { noun: "attendance_record", view: "view=attendance__display&params_submitted=1&cohortids[]=c-2&start_date=2026-01-01&end_date=2026-12-31&format=sequential&order=status", title: "Display attendance", samples: ["Dennis Demo"] },
];
