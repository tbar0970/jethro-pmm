...
class View_Services__Edit_Service_Program extends View_Services__Display_Service_Program
{
	...
	function printQuickNavLinks()
	{
		...
		?>
		<a href="<?php echo build_url(Array('view' => 'services__display_service_program')); ?>"><i class="icon-th"></i>Show the read-only version</a>
		<?php
	}
	...
	function _printServiceProgram()
	{
		...
		<table class="table roster table-width-auto service-program">
			<thead>
				<tr>
					<th>Date</th>
				<?php
