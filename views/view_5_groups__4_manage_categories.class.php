...
class View_Groups__Manage_Categories extends View
{
	...
	function printView()
	{
		...
		<div class="container row-fluid">
			<p class="span8">
				A person group in Jethro can be uncategorised, or it can belong to one group category.<br />Group categories may exist at the top level, or within another category.
			</p>
			<div class="span4 align-right">
				<a href="?view=_add_group_category"><i class="icon-plus-sign"></i>Add a new group category</a>
			</div>
		</div>
				...
				<tr>
					...
					<td class="action-cell narrow">
						<form class="min" style="clear: both" method="post" onsubmit="return confirm('Are you sure you want to delete this category?')">
							...
							<button type="submit" class="btn-link"><i class="icon-trash"></i>Delete</button>
						</form>
					</td>
				</tr>
				<?php
