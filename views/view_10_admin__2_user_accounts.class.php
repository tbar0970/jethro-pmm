...
class View_Admin__User_Accounts extends View
{
	...
	{
		?>
		<p><a href="?view=_add_user_account"><i class="icon-plus-sign"></i>Add User Account</a></p>
		...
		foreach ($congs as $id => $sm) {
			...
			<tr<?php if (!$sm['active']) echo ' class="archived"'; ?>>
				...
				<td class="narrow"><a href="?view=_edit_user_account&staff_member_id=<?php echo $id; ?>"><i class="icon-wrench"></i>Edit</a></td>
			</tr>
			<?php
		}
		?>
