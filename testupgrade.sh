...
set -o pipefail
set -x
mariadb_recreate_db --charset=utf8 --collation=utf8_unicode_ci jethro
zcat tests/functional/testdata/demodata-utf8mb3-2.38.0.sql.gz | mariadb_rename --database jethro | mariadb jethro
