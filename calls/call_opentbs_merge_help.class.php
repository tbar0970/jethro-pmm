	...
	function run()
	{
		...
		<html>
			...
			<body>
				...
				<li>[family.mobile_tels] - mobile numbers of the adults</li>
				<li>[family.emails] - email addresses of the adults</li>
				<li>[family.status]</li>
				<li>[family.created_date] - when added to the system</li>
				<li>[family.members] - first names</li>
				<li>[family.members_full] - full names</li>
				<li>[family.adult_members] - first names</li>
				<li>[family.adult_members_full] - full names</li>
				...
				<li>[family.selected_names] - full names</li>
				</ul>		
				<a href="#top" alt="return to top of page">top</a></p>
